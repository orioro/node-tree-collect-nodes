 ...
 * @property {NodeCollector[]} collectors
 */
...
export const arrayNodeCollector = (): NodeCollector => [
...
export const objectNodeCollector = (): NodeCollector => [
...
export const treeCollectNodes = (
  ...
  return cascadeExec(test, context.collectors, value, context)
}
